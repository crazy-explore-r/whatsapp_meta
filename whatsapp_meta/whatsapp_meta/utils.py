...
import json
import string
from whatsapp_meta.whatsapp_meta.doctype.whatsapp_communication.whatsapp_communication import WhatsAppCommunication
from frappe.utils.print_format import download_pdf
from whatsapp_meta.whatsapp_meta.pdf_utils import *
...
def send_welcome_message(phone_number, parameters = None):
	...
	welcome_message_template = frappe.db.get_single_value("WhatsApp Settings", "welcome_message_template")
